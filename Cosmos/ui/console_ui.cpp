...
namespace ui {
    ...
    void PrintAvailableActions(Player& player,
        ...
        for (size_t i = 0; i < action_ids.size(); ++i) {
            ...
            if (it != action_map.end()) {
                ...
                if (stat_name == "СИЛ") success_percent = player.strength;
                else if (stat_name == "ЛОВ") success_percent = player.agility;
                else if (stat_name == "ИНТ") success_percent = player.intellect;
                else if (stat_name == "ВЫН") success_percent = player.endurance;
    ...
    void ShowGameIntro() {
        ...
        PrintColored("На станции вас могут атаковать монстры с уникальными стихиями. "
            "Чтобы победить их, нужно продумать\n", 12);
