...
public:
  ...
  Monster(const std::string& name, int health, Element element,
    Element weakness);
...
public:
  ...
  Action(const std::string& id = "", const std::string& desc = "",
...
public:
  ...
  Room(int id = -1, const std::string& name = "", const std::string& desc = "",
...
public:
  std::string name;
  Element element;
  int min_neutral_damage;
  int max_neutral_damage;
  int min_weak_damage;
  int max_weak_damage;
  int crit_chance;

  Weapon(const std::string& name, Element element,
...
struct CombatConfig {
  ...
  int min_monster_damage;
  int max_monster_damage;
  int melee_crit_chance;
};